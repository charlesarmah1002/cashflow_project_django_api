...
INSTALLED_APPS = [
    ...
    "corsheaders", "rest_framework", "django_filters", "core", "accounts", "transactions", "reports",
]
MIDDLEWARE = [
...
CORS_ALLOWED_ORIGINS = [
    origin.strip()
    for origin in config("CORS_ALLOWED_ORIGINS", default="http://localhost:3000,http://localhost:5173").split(",")
    if origin.strip()
]
